          ...
          <section className="blog-cards-section" aria-label="Blog posts">
            <div className="wrap">
              <div className="blog-cards-head reveal">
                ...
                <p className="section-intro">Pick an article on laser screed floors, Midwestern foundations, or long-tenure crews - then open the full story.</p>
              </div>
          ...
          <section className="cta-band">
            ...
            <div className="cta-band-inner reveal">
              <div className="cta-band-copy">
                ...
                <p>If a foundation, warehouse floor, or crew question is on your desk, send the plans or call the shop and we will walk the scope with you.</p>
              </div>
